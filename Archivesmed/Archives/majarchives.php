...
<font size ="2" face="Arial"> <a href="../Archives/selectarchives.html">Liste de dossiers</a></font><img src="../images/newanime.gif" alt="nouveau">
<?php
if ((strlen($NPP)>1)&&($action == 'submitted')&&(((identitehexagone($NPP,$NOM,$PRENOM,$NOMJF,$DATENAISSANCE) or identite($NPP,$NOM,$PRENOM,$NOMJF,$DATENAISSANCE)))))
     {print "<br><font size ='2' face='Arial'> 
	<a href='../Archives/imp_archives.php?NPP=".$NPP."&NOM=".$NOM."&PRENOM=".$PRENOM."'>Etiquette du dossier</a>
	</font><img src='../images/newanime.gif' alt='etiquettes'>";
     }

?>
<form  method="POST" action="majarchives.php">
  <div align="center">
    ...
    <table BGCOLOR="#B7DBFF" BORDERCOLOR="#FFFFFF"  BORDER="1"  CELLSPACING="0" CELLSPADDING="14" width="401" height="273">
      ...
      <tr>
        <td width="151" height="29"><label for="fp5"><font face="Arial">Motif&nbsp;</font> </label></td>
